...
from paz.models.detection.utils import create_prior_boxes, create_multibox_head

WEIGHT_PATH = (
    'https://github.com/oarriaga/altamira-data/releases/download/v0.2/')


def SSD300_baseline(num_classes=21, base_weights='VOC', head_weights='VOC',
