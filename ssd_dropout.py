...
def SSD300_dropout(num_classes=21, base_weights='VOC', head_weights='VOC',
    ...
    conv8_1 = StochasticDropout(prob)(conv8_1)
    ...
    conv9_1 = StochasticDropout(prob)(conv9_1)
