"""
This file is a copy-paste of the paz.detection.evaluation file. Has some minor modifications to resize images to fit the
SSD300 architecture.
"""

import numpy as np
from paz.backend.boxes import compute_ious
from paz.backend.image import load_image, resize_image, cast_image
